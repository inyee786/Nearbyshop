...
public class Fair extends AppCompatActivity {
    ...
    public void finalsubmit() {
        initializes();
        if (!validate()) {
            Toast.makeText(Fair.this, "please fill the detail", Toast.LENGTH_SHORT).show();
        } else {
            AddFair();
            Intent i = new Intent(Fair.this, MainActivity.class);
            Toast.makeText(Fair.this, "THANK U FOR SIGN UP", Toast.LENGTH_LONG).show();
            startActivity(i);
        }
    }
    ...
    public void AddFair() {
        ...
        if (insertAdress) {
            Toast.makeText(Fair.this, "data inserted", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(Fair.this, "data  cannot be inserted", Toast.LENGTH_SHORT).show();
        }
        Intent i = new Intent(Fair.this, OwnerPage.class);
        startActivity(i);
    }
